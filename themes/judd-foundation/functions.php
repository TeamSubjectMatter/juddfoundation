...
function judd_foundation_scripts() {
	...
	if(is_page_template( 'page-single-content' ) ||
	   is_page_template( 'page-gallery-view-b' ) ||
	   is_page_template( 'page-two-column-utility' ) ||
	   is_page_template( 'page-section-landing' )
	) {
